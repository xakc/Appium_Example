...
public class MobileTest {
    ...
    private static void startAndroid() {
        ...
        caps.setCapability(MobileCapabilityType.DEVICE_NAME, "Nexus5Api24");
        caps.setCapability(AndroidMobileCapabilityType.AVD, "Nexus5Api24");
        caps.setCapability(MobileCapabilityType.AUTOMATION_NAME, AutomationName.ANDROID_UIAUTOMATOR2);
        caps.setCapability(MobileCapabilityType.APP, getAppPath("Android-NativeDemoApp-0.2.1.apk"));
        caps.setCapability(AndroidMobileCapabilityType.APP_WAIT_DURATION, 330);
